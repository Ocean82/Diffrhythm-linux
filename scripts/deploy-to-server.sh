...
if [ ! -f "$SSH_KEY" ]; then
    ...
    echo ""
    echo "This EC2 instance requires: Burnt-Beats-KEY.pem"
    echo ""
    echo "Searched locations:"
    echo "  - C:\\Users\\sammy\\OneDrive\\Desktop\\AWS ITEMS\\Burnt-Beats-KEY.pem"
    echo "  - C:\\Users\\sammy\\OneDrive\\Desktop\\KEYS\\Burnt-Beats-KEY.pem"
    echo "  - D:\\BURNING-EMBERS\\Burnt-Beats-KEY.pem"
    echo "  - D:\\SERVER-SAVER\\Burnt-Beats-KEY.pem"
    echo "  - C:\\Users\\sammy\\OneDrive\\Desktop\\ssl certificates\\burntbeats\\Burnt-Beats-KEY.pem"
    echo "  - C:\\Users\\sammy\\.ssh\\Burnt-Beats-KEY.pem"
    echo ""
    echo "Please:"
    echo "  1. Download Burnt-Beats-KEY.pem from AWS Console"
    echo "  2. Place it in one of the locations above"
    echo "  3. Or set SSH_KEY environment variable:"
    echo "     export SSH_KEY=\"/path/to/Burnt-Beats-KEY.pem\""
    echo "     bash scripts/deploy-to-server.sh"
    echo ""
    echo "To download the key:"
